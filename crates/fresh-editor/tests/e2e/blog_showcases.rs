        ...
        let diagnostics = vec![
            lsp_types::Diagnostic {
                range: lsp_types::Range {
                    start: lsp_types::Position { line: 1, character: 18 },
                    end: lsp_types::Position { line: 1, character: 25 },
                },
            ...
            lsp_types::Diagnostic {
                range: lsp_types::Range {
                    start: lsp_types::Position { line: 2, character: 12 },
                    end: lsp_types::Position { line: 2, character: 28 },
                },
                severity: Some(lsp_types::DiagnosticSeverity::ERROR),
            ...
            lsp_types::Diagnostic {
                range: lsp_types::Range {
                    start: lsp_types::Position { line: 3, character: 19 },
                    end: lsp_types::Position { line: 3, character: 21 },
                },
